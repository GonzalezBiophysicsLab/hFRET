function varargout = vbscope_analyze_traces(varargin)
% VBSCOPE_ANALYZE_TRACES MATLAB code for vbscope_analyze_traces.fig
%      VBSCOPE_ANALYZE_TRACES, by itself, creates a new VBSCOPE_ANALYZE_TRACES or raises the existing
%      singleton*.
%
%      H = VBSCOPE_ANALYZE_TRACES returns the handle to a new VBSCOPE_ANALYZE_TRACES or the handle to
%      the existing singleton*.
%
%      VBSCOPE_ANALYZE_TRACES('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in VBSCOPE_ANALYZE_TRACES.M with the given input arguments.
%
%      VBSCOPE_ANALYZE_TRACES('Property','Value',...) creates a new VBSCOPE_ANALYZE_TRACES or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before vbscope_analyze_traces_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to vbscope_analyze_traces_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help vbscope_analyze_traces

% Last Modified by GUIDE v2.5 04-Sep-2016 16:29:04

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @vbscope_analyze_traces_OpeningFcn, ...
                   'gui_OutputFcn',  @vbscope_analyze_traces_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before vbscope_analyze_traces is made visible.
function vbscope_analyze_traces_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to vbscope_analyze_traces (see VARARGIN)

% Choose default command line output for vbscope_analyze_traces
...
% UIWAIT makes vbscope_analyze_traces wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = vbscope_analyze_traces_OutputFcn(hObject, eventdata, handles) 
